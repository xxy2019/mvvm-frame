...
public class MaterialDialogUtils {
    ...
    public void showThemed(Context context, String
        ...
        new MaterialDialog.Builder(context)
                ...
                .btnSelector(com.afollestad.materialdialogs.R.drawable.md_selector, DialogAction.POSITIVE)
...
//                .checkBoxPromptRes(R.string.app_name, false, null)
    ...
    public static MaterialDialog.Builder showMultiListDialog(final Context context, String title, List
        ...
        MaterialDialog.Builder builder = new MaterialDialog.Builder(context)
                ...
                .positiveText(com.afollestad.materialdialogs.commons.R.string.md_choose_label)
                .autoDismiss(false)
                .neutralText("clear")

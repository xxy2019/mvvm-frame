...
public class RetrofitClientUtils {
    ...
    public static RetrofitClientUtils getInstance() {
    ...
    private RetrofitClientUtils(String url, Map<String, String> headers) {
        ...
        if (httpCacheDirectory == null) {
            httpCacheDirectory = new File(mContext.getCacheDir(), "mvvm_cache");
        }
        try {
            if (cache == null) {
